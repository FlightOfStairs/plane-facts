...
export function fig525PowerAnchorPx(pressureAltFt: number): number {
  return axisPx(fig525Meta.axes.pressureAltFt!, pressureAltFt);
}
...
export const fig525Anchors: ChartAnchors = {
  ...
  power: { axis: "rangeNmReserve45", atPx: 0, point: "down", color: "weight" },
