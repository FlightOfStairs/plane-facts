...
const AXIS_BOTTOM = axisPx(fig507Meta.axes.distanceFt!, 0);
/** Right-hand distance scale, where the trace exits. */
const READOUT_X = axisPx(fig507Meta.axes.windKt!, 15);
...
export function fig507PaAnchorPx(oatC: number): number {
  return axisPx(fig507Meta.axes.oatC!, oatC);
}

export const fig507Anchors: ChartAnchors = {
