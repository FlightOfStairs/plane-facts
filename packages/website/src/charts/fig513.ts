...
const AXIS_BOTTOM = axisPx(fig513Meta.axes.distanceFt!, 0);
/** Right-hand distance scale, where the trace exits. */
const READOUT_X = axisPx(fig513Meta.axes.windKt!, 15);
...
export function fig513PaAnchorPx(oatC: number): number {
  return axisPx(fig513Meta.axes.oatC!, oatC);
}

export const fig513Anchors: ChartAnchors = {
