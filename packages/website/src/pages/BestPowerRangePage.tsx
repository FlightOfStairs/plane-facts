  ...
  return (
    <Grid container spacing={2}>
      ...
      <Grid size={{ xs: 12, md: 8 }}>
        ...
        <ModelNotes form={["range = R₀ + slope·PA + ΔT corr        (per {reserve policy} × {55/65/75%} line)", "ΔT corr = +0.6 nm/°C above std, −1.0 nm/°C below", "Tstd = 15 − 1.9812·PA/1000"]} fit="Six straight lines fitted at 0.084% rms overall (worst curve 0.15%). The chart's printed example (5000 ft, 16 °C, 75% → 507.6 / 567.6 nm with/without reserve) reproduces at 508.6 / 566.3 nm (+0.2%)." findings={["The range axis carries two offset 50-nm scales on one lattice — the no-reserve family reads 150 nm lower than the reserve scale at the same grid position (the sibling Fig 5-27 offset is 100 nm); gridline-only calibration is essential.", "The temperature correction is two-sided and asymmetric: being cold costs 1.0 nm/°C while being warm only gains 0.6 — the drafted line is not tangent to any single physical model.", "75% curves end near 9,000 ft — the full-throttle limit, consistent with the engine and cruise charts' ceiling picture (65% curves run to 12–13,000 ft).", "Range includes the distance to climb and descend, so dividing by the Fig 5-29 endurance gives a whole-flight average block TAS.", "Best economy (Fig 5-27) beats this chart by 13–16% range at equal nominal %power for only ~4 kt TAS.", "Reserve vs no-reserve deltas are only ~5% self-consistent across the chart families — read each family absolutely rather than composing differences."]} />
      </Grid>
    </Grid>
  );
}
